#!/usr/bin/env node
/**
 * DIA 3 Automation Script v3 - Sprint 3
 * Reorganiza translations em módulos (com fix: trailing commas)
 */
...
function extractObjectFromFile(filePath) {
  ...
  // FIX: Remove trailing commas (TypeScript permite, eval não)
...
async function main() {
  console.log('\n🚀 DIA 3 v3 - Reorganização de Translations\n');
