...
const INJECTED_STYLES = `
  ...
  .integr8-card {
    background: linear-gradient(145deg, #0a1628 0%, #05080f 100%);
    box-shadow:
...
export function AppCinematic() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-screen h-screen overflow-hidden flex items-center justify-center bg-[#05080f]"
    ...
    >
      ...
      <div className="app-text-track gsap-reveal absolute z-10 flex flex-col items-center justify-center text-center w-screen px-6">
        ...
        <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-white leading-tight mb-4">
          Acompanhamento real.<br />No bolso.
        </h2>
          ...
          <div className="relative w-full h-full flex items-center justify-center z-10 p-8">
            ...
            >
              <div className="relative w-[260px] h-[540px] rounded-[2.8rem] iphone-bezel flex flex-col">
                ...
                {/* Screen */}
                <div className="absolute inset-[7px] bg-[#05080f] rounded-[2.4rem] overflow-hidden text-white z-10">
                  ...
                  {/* App content */}
                  <div className="relative w-full h-full pt-10 px-4 pb-6 flex flex-col bg-[#05080f]">
                    <div className="flex justify-between items-center mb-6 mt-2">
                      <div>
                        <div className="text-[9px] text-[#64748b] uppercase tracking-widest font-bold">Protocolo</div>
                        <div className="text-base font-bold text-white">C.O.R.E. 8</div>
                      </div>
                    ...
                    <div className="flex-1 rounded-xl overflow-hidden bg-[#0d1117] border border-[#1e293b] flex items-center justify-center">
                      <img
                    ...
                    <div className="mt-4 grid grid-cols-3 gap-2">
                      {[
                        ...
                        { label: "Pilares", value: "8" },
                      ].map((m) => (
                        <div key={m.label} className="bg-[#0d1117] border border-[#1e293b] rounded-lg p-2 text-center">
                          <div className="text-lg font-black text-[#22c55e]">{m.value}</div>
                          <div className="text-[8px] text-[#475569] uppercase tracking-wider">{m.label}</div>
                        </div>
                      ))}
                    </div>
